...
if ($_SESSION['LEmail']) {
    ...
    $sql="select * from LMS.librarians where Email='$email'";
                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <li class="active">
                                ...
                                <li>
                                    <a href="book.php"><i class="menu-icon icon-book"></i>Manage Catalogue</a>
                                </li>
                                <li>
                                    <a href="addbook.php"><i class="menu-icon icon-edit"></i>Add Books </a>
                                </li>
                                <li>
                                    <a href="requests.php"><i class="menu-icon icon-tasks"></i>Issue/Renew/Return Requests</a>
                                </li>
                                <li>
                                    <a href="recommendations.php"><i class="menu-icon icon-list"></i>Book Addition Requests</a>
                                </li>
                                <li>
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select * from LMS.record,LMS.book,LMS.renew where renew.BookId=book.BookId and renew.Email=record.Email and renew.BookId=record.BookId";
                            $result=$conn->query($sql);
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
                                        if($renewals > 0)
                                        {echo "<a href=\"acceptrenewal.php?id1=".$bookid."&id2=".$email."\" class=\"btn btn-success\">Accept</a>";}
                                         ?>
