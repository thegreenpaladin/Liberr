...
<html>
    ...
    <body class="vh-100 bg-dark text-light">
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary ps-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav ms-auto text-dark">
                <a class="nav-item nav-link text-dark" href="../student/login.php">Switch to Student</a>
        ...
        <div class="d-flex">
            ...
            <div class="d-flex justify-content-center w-25 h-100 float-end pt-3 pb-2 me-5 mt-3 rounded-3 text-dark bg-secondary">
...
if(isset($_POST['signin'])) {
    ...
    $sql="select * from LMS.librarians where Email='$e'";
