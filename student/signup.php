        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary ps-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav ms-auto text-dark">
                <!-- <a class="nav-item nav-link text-dark" href="shome.html">Switch to Librarian</a> -->
...
if(isset($_POST['signup'])) {
	...
	$sql="insert into LMS.user (Name,Email,Password,ContactNo) values ('$name', '$email', '$password', '$contact')";
