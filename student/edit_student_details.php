                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav pull-right">
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="../../user.svg" class="nav-avatar" />
                                <?php
                                    echo $name;
                                ?>
                                <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="home.php">Your Profile</a></li>
                                    <li class="divider"></li>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active">
                                    <a href="home.php"><i class="menu-icon icon-home"></i>Home</a>
                                </li>
                                <li>
                                    <a href="message.php"><i class="menu-icon icon-inbox"></i>Messages</a>
                                </li>
                                <li>
                                    <a href="book.php"><i class="menu-icon icon-book"></i>View Catalogue</a>
                                </li>
                                <li>
                                    <a href="history.php"><i class="menu-icon icon-tasks"></i>Previously Borrowed Books</a>
                                </li>
                                <li>
                                    <a href="recommendations.php"><i class="menu-icon icon-list"></i>Request to Add Books</a>
                                </li>
                                <li>
                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            ?>    
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?Email=<?php echo $email ?>" method="post">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="MobNo" name="ContactNum" value= "<?php echo $contact?>" class="span8" required>
                                        </div>
                                    </div>
...
$sql1="update LMS.user set Name='$name', ContactNo='$contact', Password='$pswd' where Email='$email'";



if($conn->query($sql1) === TRUE){
echo "<script type='text/javascript'>alert('Success')</script>";
header( "Refresh:0.01; url=home.php", true, 303);
}
else
{//echo $conn->error;
